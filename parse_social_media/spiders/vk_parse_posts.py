...
class VkParsePostsSpider1(scrapy.Spider):
    ...
    def parse(self, response: HtmlResponse):
        ...
        number_of_requests = math.ceil(count_posts / 50)
        ...
        number_iter_posts = math.ceil(number_posts_in_request/50)
